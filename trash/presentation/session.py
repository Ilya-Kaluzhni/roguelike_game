# src7/core/game/session.py

from src7.domain.characters.character import Character
from src7.domain.map_generate.map_generate import MapGenerator
...
class GameSession:
    ...
    def spawn_enemies(self):
        ...
        if level <= 3:
            enemy_types = [Zombie, Ghost]  # Только слабые враги на низких уровнях
        elif 4 <= level <= 6:
            enemy_types = [Zombie, Ghost, Vampire]  # Добавляем вампиров на средних уровнях
        elif 7 <= level <= 9:
            enemy_types = [Zombie, Vampire, Ogre]  # Добавляем огров на более высокие уровни
        else:
            enemy_types = [Zombie, Vampire, Ogre, SnakeMage]  # Самые сильные враги на высоком уровне

            # Увеличиваем количество врагов с каждым уровнем
        num_enemies = min(num_enemies + level // 2, 20)  # Пример увеличения врагов с уровнем (не больше 20 врагов)
        ...
        for _ in range(num_enemies):
            ...
            # Выбираем случайный тип врага из доступных для текущего уровня
        ...
        # from src7.core.entities.snake import Snake
        #
